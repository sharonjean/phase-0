...
#.sort method returns an array sorted
#non-destructively, which is to say it #does not alter the original array.
#Each value was converted to downcase #strings (used downcase methods because
#uppercase letters come before lowercase #letters in Ruby), and sorted alphabetically.
...
#
#Having to relay the information back to our
#peers made me think about it like pseudocode. How can I make this as accessible and relative to the reader.